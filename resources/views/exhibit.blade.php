        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <input type="file" id="exhibit_file" name="exhibit_file" class="form-control" />
                </div>
                ...
                <div class="">
                    <div class="row">
                        <div class="col-sm-12 d-flex justify-content-center">
                            <button type="button" class="btn btn-primary waves-effect waves-light"><i class="fas fa-save me-1"></i>出品する</button>
                        </div>
                    </div>
                </div>
            </div>
