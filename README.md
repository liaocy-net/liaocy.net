...
```
  - DEV
```bash
php artisan queue:listen --queue=update_amazon_jp_exhibit_001,update_yahoo_jp_exhibit_001,exhibit_to_amazon_jp_001,exhibit_to_yahoo_jp_001,process_asin_file_001,extract_amazon_info_for_exhibit_001,update_amazon_info_001,extract_amazon_info_001,download_amazon_jp_product_images

php artisan queue:work --queue=update_amazon_jp_exhibit_001,update_yahoo_jp_exhibit_001,exhibit_to_amazon_jp_001,exhibit_to_yahoo_jp_001,process_asin_file_001,extract_amazon_info_for_exhibit_001,update_amazon_info_001,extract_amazon_info_001,download_amazon_jp_product_images
```
...
- EFS
  - [【AWS EFS】共有ファイルストレージ構築](https://qiita.com/OPySPGcLYpJE0Tc/items/adb807df4c4fb305006b)
  - [手动安装 Amazon EFS 客户端](https://docs.aws.amazon.com/zh_cn/efs/latest/ug/installing-amazon-efs-utils.html)
